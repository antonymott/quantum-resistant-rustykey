...
declare function exportKey(format: "jwk", key: CryptoKey): Promise<JsonWebKey>;
declare function exportKey(format: Exclude<MlKemKeyFormat, "jwk">, key: CryptoKey): Promise<ArrayBuffer>;
